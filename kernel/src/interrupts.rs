...
fn remap_pic() {
    ...
    unsafe {
        command1.write(0x11u8); command2.write(0x11u8);
        data1.write(0x20u8); data2.write(0x28u8);
        data1.write(0x04u8); data2.write(0x02u8);
        data1.write(0x01u8); data2.write(0x01u8);
        data1.write(0xFCu8); data2.write(0xFFu8);
    }
}
...
fn unmask_irq(irq: u8) {
    ...
    unsafe { data.write(current & !(1 << bit)); }
}
